$(function() {
    ...
    $(window).scroll(function() {
        ...
        if (value > header) {
            ...
            $('.footer-fixed').addClass('footer-media');
        } else {
            $('.top-nav2').removeClass('header');
            $('.footer-fixed').removeClass('footer-media');
        }
    });
    ...
    $(window).on('click media', function() {
        var width = $(window).width();
        if(width < 744) {
            $('.btn-section').removeClass('btn-section-click');
        } else {
            $('.btn-section').addClass('btn-section-click');
        }
    });
